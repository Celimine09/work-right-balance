...
function PiroteNotificationCard({ className, onClick }: { className?: string, onClick?: () => void }) {
  ...
  return (
    ...
    >
      {isHovered ? (
        <img alt="Notification Hover" className="absolute block size-full max-w-none" src={imgNotificationHover} />
      ) : (
        <>
          <img alt="Notification Background" className="absolute block size-full max-w-none" src={imgNotificationCardBackground} />
          <div className="absolute inset-[57.29%_3.76%_18.12%_25.37%]">
            <img alt="Message" className="absolute block size-full max-w-none" src={imgNotificationMessageText} />
          </div>
          <div className="absolute inset-[24.05%_49.53%_55.6%_25.47%]">
            <img alt="Title" className="absolute block size-full max-w-none" src={imgNotificationTitleText} />
          </div>
            ...
            <div className="flex h-[126.99px] w-[112.05px] flex-none -scale-y-100 rotate-180 items-center justify-center">
              <div className="relative size-full">
                <div className="pointer-events-none absolute inset-0 overflow-hidden">
                  <img alt="Avatar" className="absolute left-0 top-0 size-full max-w-none" src={imgNotificationAvatar} />
                </div>
              </div>
            </div>
          </div>
...
function Game2Artboard() {
  const tf = { "--transform-inner-width": "1200", "--transform-inner-height": "19" } as CSSProperties;
  ...
  const currentAnswer = 
    currentStep === 1 ? "สะดวกมากครับ" : 
    currentStep === 2 ? "ไหวชิวครับ" : 
    "สะบายครับ";

  const handleTogglePlay = () => {
    setIsPlaying(!isPlaying);
    if (!isPlaying) console.log("Playing music..."); 
    else console.log("Paused music."); 
  };
  ...
  return (
    ...
    >
      <div className="absolute contents left-0 top-0" data-name="bg">
        <div className="absolute left-0 top-0 h-[4320px] w-[1920px] bg-[#7ec3ef]" data-name="พื้นหลังฟ้า" />
      ...
      <div className="absolute inset-[8.19%_-10.68%_70.31%_39.38%]" data-name="เสื้อ">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 top-0 size-full max-w-none" src={imgFoldedShirts} />
        </div>
      </div>

      <div className="absolute left-[-449px] top-[704px] flex h-[1123.446px] w-[1162.158px] items-center justify-center" style={tf}>
        <div className="flex-none rotate-[49.06deg]">
          <div className="relative h-[1003.201px] w-[617.04px]" data-name="แปรง">
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              <img alt="" className="absolute -left-[92.55%] -top-[5.4%] h-[109.98%] w-[317.88%] max-w-none" src={imgToothbrush} />
            </div>
          </div>
        </div>
      </div>

      <div className="absolute contents left-[129px] top-[82px]" data-name="กิจกรรมอัตโน...ชำนาญ">
          ...
          <div className="h-[127.36px] w-[690.717px] flex-none rotate-[-6.08deg]">
            <div className="relative size-full" data-name="กิจกรรมอัตโนมัติ">
              <div className="absolute inset-[-1.11%_-0.21%_-1.18%_-0.21%]">
                <img alt="" className="block size-full max-w-none" src={imgTitleAutomaticActivity} />
              </div>
            </div>
          </div>
        </div>
        <div className="absolute left-[853px] top-[82px] h-[272px] w-[314px]" data-name="คือ">
          <img alt="" className="pointer-events-none absolute inset-0 size-full max-w-none object-cover" src={imgTextKueIs} />
        </div>
        <div className="absolute contents left-[829px] top-[383px]" data-name="สิ่งที่ทำหรือ">
          <div className="absolute left-[829px] top-[383px] h-[63px] w-[326px]">
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              <img alt="" className="absolute left-0 top-[-0.02%] h-[344.49%] w-[159.2%] max-w-none" src={imgThaiTypographySpritesheet} />
            </div>
          </div>
          <div className="absolute left-[1135px] top-[402px] h-[120px] w-[272px]">
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              <img alt="" className="absolute left-[-227.97%] top-[-0.02%] h-[344.49%] w-[362.94%] max-w-none" src={imgThaiTypographySpritesheet} />
            </div>
          </div>
        </div>
      </div>

      <div className="absolute contents left-[221px] top-[939px]" data-name="สิ่งที่คาดเดา...ซ้ำๆ">
        <div className="absolute left-[221px] top-[1098px] h-[79px] w-[281px]">
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <img alt="" className="absolute left-0 top-[-77.23%] h-[274.72%] w-[184.7%] max-w-none" src={imgThaiTypographySpritesheet} />
          </div>
        </div>
        <div className="absolute left-[272px] top-[1148px] h-[127px] w-[370px]">
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <img alt="" className="absolute left-[-125.65%] top-[-77.23%] h-[274.72%] w-[225.65%] max-w-none" src={imgThaiTypographySpritesheet} />
          </div>
        </div>
        <div className="absolute contents inset-[21.74%_43.43%_65.91%_21.46%]" data-name="ซ้ำๆ">
          <div className="absolute inset-[27.96%_43.43%_65.91%_36.68%]"><img alt="" className="absolute block size-full max-w-none" src={imgRepeatSamLarge} /></div>
          <div className="absolute inset-[28.11%_64.55%_68.96%_25.91%]"><img alt="" className="absolute block size-full max-w-none" src={imgRepeatSamMedium} /></div>
          <div className="absolute inset-[24.55%_61.17%_73.07%_31.11%]"><img alt="" className="absolute block size-full max-w-none" src={imgRepeatSamSmall} /></div>
          <div className="absolute inset-[21.74%_69.42%_76.42%_24.59%]"><img alt="" className="absolute block size-full max-w-none" src={imgRepeatSamTiny1} /></div>
          <div className="absolute inset-[23.13%_74.17%_75.52%_21.46%]"><img alt="" className="absolute block size-full max-w-none" src={imgRepeatSamTiny2} /></div>
        </div>
      </div>

      <div className="absolute left-[75px] top-[1342px] h-[342px] w-[670px] overflow-clip" data-name="สบู่">
        <div className="absolute inset-[0_0.52%_0.52%_0]">
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <img alt="" className="absolute left-0 top-0 size-full max-w-none" src={imgSoapBar} />
          </div>
        </div>
      </div>

      <div className="absolute contents left-[779px] top-[1538px]" data-name="หรือเป็นแพทเทิร์น">
        <div className="absolute left-[1150px] top-[1538px] w-[700px]"> 
          <img alt="รูปภาพแพทเทิร์น" className="block size-full max-w-none object-contain" src={imgPattern} />
        </div>
      </div>

      <div className="absolute left-[331px] top-[3181px] h-[161.06px] w-[541.14px] z-10" data-name="เพลง">
        <div className="absolute inset-0 contents">
          <img alt="" className="absolute block size-full max-w-none" src={imgMusicPlayerPanel} />
          <div className="absolute inset-[14.11%_48%_64.5%_6.96%] flex items-center">
            <img
              ...
              src={isNextSong ? imgMusicPlayerAlbumArt2 : imgMusicPlayerAlbumArt}
            />
          </div>
          <div className="absolute inset-[43.28%_9.19%_56.1%_6.96%]"><img alt="" className="absolute block size-full max-w-none" src={imgMusicPlayerScrubber} /></div>
          <div className="absolute inset-[37.58%_92.78%_50.41%_6.7%]"><img alt="" className="absolute block size-full max-w-none" src={imgMusicPlayerSpeakerIcon} /></div>
        ...
        >
          <img alt="Skip" className="absolute block size-full max-w-none" src={imgMusicPlayerSkipIcon} />
        </button>
      </div>
          ...
          <div className="absolute left-[1015px] top-[2588px] z-10">
            <div className="relative h-full w-full">
              <img
                ...
                src={
                  currentStep === 1 ? imgBoss : 
                  currentStep === 2 ? imgBoss2 : 
                  imgBoss3
                }
              />
            </div>
              ...
              <div className="p-[30px] pb-[40px] text-gray-800 text-[16px] leading-relaxed h-[300px] overflow-y-auto">
                {currentStep === 1 ? (
                  <>
                    ...
                    <p>สวัสดีค่ะ ทางเรากำลังมองหาบริษัทที่สนใจรับงาน<br/>
                    ที่รองรับงานหลากหลายรูปแบบ ไม่จำกัดขอบเขตประเภทงาน<br/>
                    ไม่จำกัดเวลาในการทำงาน ไม่จำกัดงบประมาณ<br/>
                    และสามารถพูดคุยปรับรายละเอียดตามความเหมาะสมได้<br/>
                    จึงขอสอบถามว่าทางบริษัท สะดวกร่วมงานลักษณะนี้ไหมคะ</p>
                  </>
                ) : currentStep === 2 ? (
                  <>
                    <p className="font-bold mb-4">ถึงบริษัท งานไม่จำกัด</p>
                    <p>สวัสดีครับ โปรเจกต์ของเรามีความทับซ้อนทางด้านคอนเซป<br/>
                    ที่ต่อเนื่องกัน จึงต้องมีการจัดงานหลายงานพร้อมๆกัน<br/>
                    และมีระยะเวลาที่ค่อนข้างกระชับ ทางเราจึงอยากสอบถามว่า<br/>
                    ทางบริษัท สามารถทำงานลักษณะนี้ไหวไหมครับ</p>
                  </>
                ) : (
                  <>
                    <p className="font-bold mb-4">ถึงบริษัท งานไม่จำกัด</p>
                    <p>สวัสดีค่ะ ทางเรากำลังมองหาทีมที่สามารถดูแลโปรเจกต์<br/>
                    หลายส่วนได้พร้อมกันในช่วงเวลาเดียวกัน โดยครอบคลุม<br/>
                    ทั้งงานครีเอทีฟ งานออกแบบ งานคอนเทนต์ ภายใต้ระยะเวลา<br/>
                    ไม่เกิน 2 เดือน จึงอยากสอบถามว่าทางบริษัทงานไม่จำกัด<br/>
                    สามารถดำเนินงานหลายส่วนควบคู่กันได้ไหมคะ</p>
                  </>
                )}
              </div>

              <form onSubmit={handleSubmit} className="flex bg-[#d11181] border-t-2 border-black h-[70px]">
                <input
                  type="text"
                  value={inputValue}
                ...
                >
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="white" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <img alt="Laptop" className="absolute left-0 top-0 size-full max-w-none" src={imgLaptop} />
        </div>
      </div>
    </section>
  );

...
export function Game1Page() {
  ...
  const textOpacityProgress = useMemo(
    () =>
      Math.min(
        1,
        Math.max(
          0,
          (virtualScroll - TEXT_FADE_START) / (TEXT_FADE_END - TEXT_FADE_START),
        ),
      ),
    [virtualScroll],
  );
  ...
  const textOpacity = useMemo(
    () => 1 - textOpacityProgress,
    [textOpacityProgress],
  );
  const isHandVisible = useMemo(
  ...
  if (petClickCount >= 8) {
    ...
    if (correctAnswersCount >= 3 && isFinalPetClicked)
  ...
  const handleWheel = (e: React.WheelEvent) => {
    ...
    setVirtualScroll((prev) =>
      Math.min(Math.max(0, prev + e.deltaY), MAX_VIRTUAL_SCROLL),
    );
  };
  ...
  const handleTouchMoveScroll = (e: React.TouchEvent) => {
    ...
    setVirtualScroll((prev) =>
      Math.min(Math.max(0, prev + deltaY), MAX_VIRTUAL_SCROLL),
    );
  };
  ...
  return (
    ...
    >
      <img
        src="/figma-assets/game1/ดอกไม้.png"
        alt="BG"
        className="absolute inset-0 h-full w-full object-cover mix-blend-overlay opacity-75 pointer-events-none z-0"
      />
          ...
          <section className="relative h-[1080px] w-[1920px] overflow-hidden bg-transparent">
            <img
              src={
                correctAnswersCount >= 3
                  ? END_CAT_GIF_SRC
                  : "/figma-assets/game1/แมว.png"
              }
              alt="Cat"
              className="absolute left-[820px] top-[234px] h-[758px] w-[1334px] rotate-[31.14deg] object-contain pointer-events-none"
            />
            ...
            <div
              ...
              style={{
                ...
                transform: `translateX(${isAnimatingHand ? -MAX_HAND_OFFSET_X : 0}px)`,
            ...
            >
              <img
                src="/figma-assets/game1/กดคลิก.png"
                alt="ขวา"
                className="absolute left-[200px] top-[350px] h-[150px] w-auto object-contain -rotate-2 drop-shadow-sm"
              />
              <img
                src="/figma-assets/game1/เพื่อลูบ.png"
                alt="เพื่อลูบ"
                className="absolute left-[260px] top-[620px] h-[150px] w-auto object-contain -rotate-2 drop-shadow-sm"
              />
              <img
                src="/figma-assets/game1/บราวนี่.png"
                alt="บราวนี่"
                className="absolute left-[520px] top-[660px] h-[150px] w-auto object-contain rotate-3 drop-shadow-sm"
              />
            </div>

            <img
              src={MOTHER_MASK_IMAGE_SRC}
              alt="Mom"
              ...
              style={{
                ...
                top: "100px",
                width: "300px",
                opacity: pettingStarted && correctAnswersCount < 3 ? 1 : 0,
            ...
            <img
              ...
              style={{
                ...
                top: "150px",
                width: "350px",
                opacity: pettingStarted && petClickCount < 3 ? 1 : 0,
                transition: "opacity 0.3s",
              }}
            />
            <img
              src={HEART1_IMAGE_SRC}
              alt="H1"
              className="absolute z-20 pointer-events-none drop-shadow-lg"
              style={{
                left: "1500px",
                top: "200px",
                width: "200px",
                opacity: pettingStarted && petClickCount < 4 ? 1 : 0,
                transition: "opacity 0.3s",
              }}
            />
            <img
              ...
              style={{
                ...
                top: "280px",
                width: "350px",
                opacity: petClickCount >= 2 && petClickCount < 3 ? 1 : 0,
                transition: "opacity 0.3s",
              }}
            />
            <img
              ...
              style={{
                ...
                top: "150px",
                width: "350px",
                opacity: petClickCount >= 3 && petClickCount < 4 ? 1 : 0,
              }}
            />
            <img
              ...
              style={{
                ...
                top: "150px",
                width: "350px",
                opacity: petClickCount >= 4 && petClickCount < 5 ? 1 : 0,
              }}
            />
            <img
              src={HEART2_IMAGE_SRC}
              alt="H2"
              className="absolute z-20 pointer-events-none drop-shadow-lg"
              style={{
                left: "1500px",
            ...
            <img
              ...
              style={{
                ...
                top: "150px",
                width: "350px",
                opacity: petClickCount === 5 ? 1 : 0,
              }}
            />
            <img
              src={HEART3_IMAGE_SRC}
              alt="H3"
              className="absolute z-20 pointer-events-none drop-shadow-lg"
              style={{
                left: "1500px",
            ...
            <img
              ...
              style={{
                ...
                top: "150px",
                width: "350px",
                opacity: petClickCount >= 8 && correctAnswersCount < 3 ? 1 : 0,
              }}
            />
            ...
            <div
              ...
              style={{
                ...
                opacity: petClickCount >= 8 && correctAnswersCount < 3 ? 1 : 0,
                pointerEvents:
                  petClickCount >= 8 && correctAnswersCount < 3
                    ? "auto"
                    : "none",
              }}
            >
